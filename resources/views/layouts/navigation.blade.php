<nav x-data="{ open: false }" class="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 z-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <img src="https://cdn-images-1.medium.com/max/1200/1*k9O0kcAdyF8qgO8arTJcAg.png" alt="Logo" class="h-9 w-auto sm:h-10">
            </div>
                <!-- Navigation Links -->
        ...
        <x-slot name="content">
        <x-dropdown-link href="{{ route('switchLang', 'en') }}">
    {{ __('messages.English') }}
</x-dropdown-link>
<x-dropdown-link href="{{ route('switchLang', 'lv') }}">
    {{ __('messages.Latvian') }}
</x-dropdown-link>
